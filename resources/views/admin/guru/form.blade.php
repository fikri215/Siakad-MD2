    ...
    <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="form-group">
                    ...
                    <input type="text" id="nama_guru" name="nama_guru" value="{!! old('nama_guru', $nama_guru ?? '') !!}" class="form-control @error('nama_guru') is-invalid @enderror">
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                    ...
                    <input type="text" id="nip" name="nip" onkeypress="return inputAngka(event)" value="{!! old('nip', $nip ?? '') !!}" class="form-control @error('nip') is-invalid @enderror">
            </div>
            <div class="form-group">
