...
@section('page')
  <div class="breadcrumb-item active"><a class="text-decoration-none" href="{{ route('profile') }}">Pengaturan</a></div>
            ...
            <div class="row" name="role" value="{{ Auth::user()->siswa(Auth::user()->no_induk)->role }}">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="text" id="nis" name="nis" onkeypress="return inputAngka(event)" value="{{ Auth::user()->siswa(Auth::user()->no_induk)->nis }}" class="form-control @error('nis') is-invalid @enderror" disabled>
                  </div>
                  <div class="form-group">
