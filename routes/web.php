...
Route::middleware(['auth'])->group(function () {
  ...
  Route::middleware(['admin'])->group(function () {
    ...
    Route::get('/guru/form', 'GuruController@create')->name('guru.form');
    ...
    Route::get('/siswa/form', 'SiswaController@create')->name('siswa.form');
    Route::get('/kelas/siswa/{id}', 'SiswaController@index')->name('siswa.show');
    ...
    Route::get('/jadwal/form', 'JadwalController@detail')->name('jadwal.form');
